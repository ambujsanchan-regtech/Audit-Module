...
public class AuditHeadMethodARS extends BasePage{
...
*/
	...
	public static void Master( ExtentTest test, XSSFWorkbook workbook) throws InterruptedException
	{
		...
		AuditHeadArsLocator.Successfully11().click();
		Thread.sleep(5000);
		
		String t3 = AuditHeadArsLocator.Successfully11().getText();
		Thread.sleep(5000);
...
// ----------------Draft Observation Listing - Save ----------------------------------------------
	...
	Thread.sleep(3000);
		...
		Thread.sleep(2000);
		List<WebElement>roc = getDriver().findElements(By.xpath("(//*[@class='highcharts-legend-item highcharts-column-series highcharts-color-0 highcharts-series-0 '])"));
		roc.get(0).click();
		Thread.sleep(3000);
	...
	Thread.sleep(3000);
	//AuditHeadArsLocator.ClickArrow().click();	
	//Thread.sleep(4000);
	AuditHeadArsLocator.Open().click();	
	Thread.sleep(3000);*/
	
	int ProcessInefficiency_Open = Integer.parseInt(AuditHeadArsLocator.Open().getText());	//Reading value of 'After Due Date'
	//AuditHeadArsLocator.ProcessInefficiencyOpen().click();								//CLicking on 'Not Completed' count
	...
	Thread.sleep(500);
	int total = high  + low;    //int total = high + medium + low;
	Thread.sleep(500);
	if(ProcessInefficiency_Open == total)
	{
		test.log(LogStatus.PASS, " 'Open' Category Count matches to sum of all risked Categorirs.");
		test.log(LogStatus.PASS, "Total - Open Category : "+total);
	}
	else
	{
		test.log(LogStatus.FAIL, "' Open' Category Count doesn't matches to sum of all risked Categorirs.");
		test.log(LogStatus.FAIL, "Total 'open' Compliances : "+total+" | Total Sum : "+ProcessInefficiency_Open);
	}
...
AuditHeadArsLocator.ProcessInefficiencyOpen(null).click();								//CLicking on 'Not Completed' count
...
//Thread.sleep(2000);
	List<WebElement>roc = getDriver().findElements(By.xpath("(//*[@class='highcharts-legend-item highcharts-column-series highcharts-color-0 highcharts-series-0'])"));
	//AuditHeadArsMethod.selectOptionFromDropDown_bs(roc.get(1), "Open");
	roc.get(1).click();
Thread.sleep(2000);
int ProcessInefficiency_Close = Integer.parseInt(AuditHeadArsLocator.Closed().getText());	//Reading value of 'After Due Date'
...
if(ProcessInefficiency_Close == total)
{
test.log(LogStatus.PASS, " Category Count matches to sum of all risked Categorirs.");
test.log(LogStatus.PASS, "Total  Close Category : "+total);
}
else
{
test.log(LogStatus.FAIL, "Close' Category Count doesn't matches to sum of all risked Categorirs.");
test.log(LogStatus.FAIL, "Total Close Category : "+total+" | Total Sum : "+ProcessInefficiency_Close);
}
...
public static void AgingGreaterthan1Year( ExtentTest test ) throws InterruptedException
{
	Thread.sleep(1000);
	AuditHeadArsLocator.ARS().click();
	Thread.sleep(3000);
...
int Aging_90 = Integer.parseInt(AuditHeadArsLocator.Click1Year().getText());	
Thread.sleep(2000);
((WebElement) AuditHeadArsLocator.Click1Year()).click();						
Thread.sleep(3000);
...
if(count1 == Aging_90)
{
	test.log(LogStatus.PASS, "'  >1 Year days Aging Count matches to number of items from grid.");
	test.log(LogStatus.PASS, "'  >1 Year days Dashboard  Count = "+ Aging_90 + " | Total no of items from grid = "+ count1);
}
else
{
	test.log(LogStatus.FAIL, "'  >1 Year Aging Count doesn't matches to number of items from grid.");
	test.log(LogStatus.FAIL, "'  >1 Year Dashboard Count = "+ Aging_90 + " | Total no of items from grid = "+ count1);
}
...
AuditHeadArsLocator.ClosePopRisk().click();
Thread.sleep(3000);
AuditHeadArsMethod.AgingGreater180to365(test);
Thread.sleep(3000);
AuditHeadArsMethod.AgingGreater90(test);
Thread.sleep(3000);
AuditHeadArsMethod.AgingGreater0to90(test);
Thread.sleep(3000);
...
Thread.sleep(7000);
WebElement roc = getDriver().findElement(By.xpath("//*[@class='highcharts-legend-item highcharts-column-series highcharts-color-undefined highcharts-series-2 ']//*[@class='highcharts-point']"));
//AuditHeadArsMethod.selectOptionFromDropDown_bs(roc.get(1), "Open");
Thread.sleep(3000);
roc.click();
Thread.sleep(3000);
...
public static void myreport(ExtentTest test,XSSFWorkbook workbook)throws InterruptedException {
	...
	// getDriver().manage().window()
	 ...
	 Thread.sleep(8000);
	 AuditHeadArsLocator.clickmyobservationsummaryreport().click();
	 Thread.sleep(8000);
	...
	// String mesg11=AuditHeadArsLocator.clickmyreportexecutivemessage().getText();
		...
		AuditHeadArsLocator.clickmyreport().click();
	 Thread.sleep(8000);
	 AuditHeadArsLocator.clickmyreportfinalaudit().click();
		 Thread.sleep(8000);
	...
	AuditHeadArsLocator.clickmyreportfinalauditselectcompany().click();
	 Thread.sleep(8000);
	 test.log(LogStatus.PASS, " :- Filters work successfully.");
	 AuditHeadArsLocator.clickmyreportfinalauditdownload().click();
	 Thread.sleep(8000);
	 ...
	 File dire = new File("C:\\Users\\ambuj\\Downloads");
		...
		Thread.sleep(500);
		AuditHeadArsLocator.clickmyreportfinalauditdownload().click(); // Exporting (Downloading) file
	...
	if (dirContentes.length < allFilesNew11.length) {
		...
		AuditHeadArsLocator.clickmyreport().click();
	   Thread.sleep(8000);
 		AuditHeadArsLocator.clickmyreportinternalaudit().click();
    	 Thread.sleep(8000);
   	...
   	AuditHeadArsLocator.clickmyreportinternalauditselectcompany().click();
   	 Thread.sleep(8000);
  	 test.log(LogStatus.PASS, " :- Filters Work successfully.");
   	AuditHeadArsLocator.clickmyreportinternalauditdownload().click();
  	 Thread.sleep(8000);
  	 test.log(LogStatus.PASS, " :- internal audit Report download successfully.");
   	AuditHeadArsLocator.clickmyreportinternalauditmessage().click();
   	 Thread.sleep(8000);
