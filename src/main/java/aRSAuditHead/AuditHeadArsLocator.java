...
public class AuditHeadArsLocator extends BasePage{
...
// -----------------------------------------------------------------------------  
     ...
     public static WebElement Successfully1()		//Method for searching Username input
  	{
    	...
    	//*[@id="ContentPlaceHolder1_ValidationSummary2"]/ul/li
  		return Successfully1;
  	}
     
     public static WebElement Successfully11()		//Method for searching Username input
   	{
     	 Successfully1 = getDriver().findElement(By.xpath("//*[@id=\"ContentPlaceHolder1_ValidationSummary2\"]/ul/li"));
   		return Successfully1;
   	}
 ...
 //--------------------------------------------------------------------
   ...
   //*[@id="ContentPlaceHolder1_udcInputForm_ValidationSummary15"]/ul/li
...
//--------------------------------------------------------------------------------------------------------
  ...
  //---------------------------------------------------------------------------
   ...
   //--------------------------------------------------------------------------------------------------------
    ...
    //---------------------------------------------------------------------------------------------------------------------
 	...
 	{
 		ars = getDriver().findElement(By.xpath("//*[@id='CMPMenuBar']/ul/li[1]"));
 		return ars;
 	}
 	...
 	public static WebElement ProcessInefficiencyOpen(WebDriver driver)		
	{
		...
		//ars = driver.findElement(By.xpath("(//*[@class='highcharts-point highcharts-color-1 highcharts-drilldown-point highcharts-point-hover'])[1]"));
	...
	public static WebElement Open()		
 	...
 	{
 				ars = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined highcharts-drilldown-data-label'])[3]"));
 				return ars;
 	}
 	...
 	{
 				ars = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined highcharts-drilldown-data-label'])[7]"));
 				return ars;
 	}
 	...
 	public static WebElement Click90days ()		
 	{
 				ars = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[7]"));
 				return ars;
 	}
 	...
 	{
 				ars = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined '])[9]"));
 				return ars;
 	}
 	...
 	{
 				ars = getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-0 '])[1]"));
 				return ars;
 	}
  ...
  //---------------------------------------------------------------------------------------------
 	...
 	public  static WebElement clickmydocument() {
 		mydocument=getDriver().findElement(By.xpath("//*[@id=\"CMPMenuBar\"]/ul/li[9]/a"));
 		//*[@id="CMPMenuBar"]/ul/li[9]/a
 		return mydocument;  
 	}
  ...
  //-----------------------------------------------------------------------------------
 	...
 	public  static WebElement clickmyreport() {
 		myreport=getDriver().findElement(By.xpath("//*[@id=\"CMPMenuBar\"]/ul/li[10]/a"));
 		return myreport;  
 	}
 	public  static WebElement clickmyobservationsummaryreport() {
 	...
 	public  static WebElement clickmyreportcompany() {
 		myreportcompany=getDriver().findElement(By.xpath("//*[@id=\"ContentPlaceHolder1_ddlLegalEntity_chosen\"]/a"));
 		//*[@id="ContentPlaceHolder1_ddlLegalEntity_chosen"]/a
 		
 		return myreportcompany;  
 	}
 	public  static WebElement clickmyreportselectcompany() {
 		myreportselectcompany=getDriver().findElement(By.xpath("//*[@id=\"ContentPlaceHolder1_ddlLegalEntity_chosen\"]/div/ul/li[2]"));
 		//*[@id="ContentPlaceHolder1_ddlLegalEntity_chosen"]/div/ul/li[2]
 		return myreportselectcompany;  
 	}
 	public  static WebElement clickmyreportexecutivedownload() {
 		myreportexecutivedownload=getDriver().findElement(By.xpath("//*[@id=\"grd_report\"]/div[2]/table/tbody/tr[1]/td[6]/a/img"));
 		//*[@id="grd_report"]/div[2]/table/tbody/tr[1]/td[6]/a/img
 		return myreportexecutivedownload;  
 	}
 	public  static WebElement clickinternalauditreport() {
 		myreportexecutivedownload=getDriver().findElement(By.xpath("//*[@id=\"CMPMenuBar:submenu:42\"]/li[5]/a"));
 	...
 	public  static WebElement clickmyreportinternalaudit() {
 		myreportinternalaudit=getDriver().findElement(By.xpath("//*[@id=\"CMPMenuBar:submenu:42\"]/li[5]/a"));
 	...
 	public  static WebElement clickmyreportexecutivereport() {
 		myreportinternalauditselectcompany=getDriver().findElement(By.xpath("//*[@id=\"CMPMenuBar:submenu:42\"]/li[4]/a"));
 		return myreportinternalauditselectcompany;  
 	}
 	
 	public  static WebElement clickfinalauditreport() {
 		myreportinternalauditselectcompany=getDriver().findElement(By.xpath("//*[@id=\"CMPMenuBar:submenu:42\"]/li[6]/a"));
 		return myreportinternalauditselectcompany;  
 	}
 	public  static WebElement clickfinalauditreportauditdownload() {
 		myreportinternalauditselectcompany=getDriver().findElement(By.xpath("//*[@id=\"ContentPlaceHolder1_grdSummaryDetailsAuditCoverage_lblDocumentDownLoadfileActionAll_0\"]"));
 		return myreportinternalauditselectcompany;  
 	}
 	...
 	public  static WebElement clickinternalauditreportdownload() {
 		myreportinternalauditdownload=getDriver().findElement(By.xpath("//*[@id=\"grd_report\"]/div[2]/table/tbody/tr[1]/td[8]/a/img"));
 		return myreportinternalauditdownload;  
 ...
 //------------------------Configuration-----------------------
	...
	public static Alert Click180to365days() {
		// TODO Auto-generated method stub
		return null;
	}


	public static WebElement Click90days1() {
		// TODO Auto-generated method stub
		return null;
	}


	public static WebElement Click90days11() {
		// TODO Auto-generated method stub
		return null;
	}


	public static Alert clickARSA() {
		// TODO Auto-generated method stub
		return null;
	}
