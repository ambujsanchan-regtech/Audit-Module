...
import aRSReviewer.ReviewerLocator;
...
//		Thread.sleep(17000);
	...
	public static void AddDocument( ExtentTest test, XSSFWorkbook workbook) throws InterruptedException
	{
		...
		String xpathExpression3 = String.format("//select[@id='grdProcessAudit_ddlPerformer_1']/option[3]",OptionText3);
		...
		String xpathExpression4 = String.format("//select[@id='grdProcessAudit_ddlReviewer_1']/option[3]",OptionText4);
...
*/
	...
	public static void MyDocument( ExtentTest test, XSSFWorkbook workbook) throws InterruptedException
	{
		...
		String xpathExpression1 = String.format("//*[@id='ContentPlaceHolder1_grdSummaryDetailsAuditCoverage_ddlDocumentFile_2']/option[1]",OptionText1);
		WebElement dropdownOption1 = getDriver().findElement(By.xpath(xpathExpression1));
		dropdownOption1.click();
		Thread.sleep(7000);
		...
		Thread.sleep(8000);
		 ReviewerLocator.Mydocumentchange().click();					                //Clicking on Dashboard count
		    Thread.sleep(5000);
	  ...
	  /* else
       ...
       String OptionText = "Option 2";
		String xpathExpression = String.format("//*[@id='ContentPlaceHolder1_grdSummaryDetailsAuditCoverage_ddlDocumentFile_2']/option[2]",OptionText);
	 ...
	 //  else
	   ...
	   Thread.sleep(4000);
	      ...
	      String OptionText2 = "Option 3";
			String xpathExpression2 = String.format("//*[@id='ContentPlaceHolder1_grdSummaryDetailsAuditCoverage_ddlDocumentFile_2']/option[3]",OptionText2);
		 ...
		 /*  else
		   ...
		   Thread.sleep(4000);
		      ...
		      String OptionText3 = "Option 4";
				String xpathExpression3 = String.format("//*[@id='ContentPlaceHolder1_grdSummaryDetailsAuditCoverage_ddlDocumentFile_2']/option[4]",OptionText3);
				WebElement dropdownOption3 = getDriver().findElement(By.xpath(xpathExpression3));
				dropdownOption3.click();
				Thread.sleep(7000);
			 ...
			 /*  else
			   ...
			   Thread.sleep(4000);
			      ...
			      String OptionText4 = "Option 5";
					String xpathExpression4 = String.format("//*[@id='ContentPlaceHolder1_grdSummaryDetailsAuditCoverage_ddlDocumentFile_2']/option[5]",OptionText4);
					WebElement dropdownOption4 = getDriver().findElement(By.xpath(xpathExpression4));
					dropdownOption4.click();
					Thread.sleep(7000);
					 ...
					 /*  else
					   ...
					   Thread.sleep(4000);
					      ...
					      String OptionText6 = "Option 7";
							String xpathExpression6 = String.format("//*[@id='ContentPlaceHolder1_grdSummaryDetailsAuditCoverage_ddlDocumentFile_2']/option[7]",OptionText6);
