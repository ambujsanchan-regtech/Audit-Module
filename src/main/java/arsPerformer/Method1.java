...
*/
	...
	public static void AddDocumentDetails( ExtentTest test, XSSFWorkbook workbook) throws InterruptedException
	{
		...
		*/
		...
		Locator1.AddDocument().click();					                //Clicking on Dashboard count
        Thread.sleep(9000);
		...
		Locator1.DocumentName().sendKeys(c1.getStringCellValue()); // Writing Task title
		Thread.sleep(2000);
		
        
    //    Locator1.DocumentName().click();					                //Clicking on Dashboard count
    //    Thread.sleep(2000);
        
        Locator1.Save().click();					                //Clicking on Dashboard count
        Thread.sleep(7000);
        	
        String t = Locator1.Successfully1().getText();				                //Clicking on Dashboard count
        Thread.sleep(2000);
		test.log(LogStatus.PASS, " Add Document - " + t);
 		Thread.sleep(2000);
         
        Locator1.Addplus().click();					                //Clicking on Dashboard count
        Thread.sleep(2000);
        
        if(Locator1.Delete().isEnabled())
 		{
		...
		*/
		...
		Thread.sleep(3000);
		 ...
		 c1 = row0.getCell(1); // Selected cell (0 row,2 column) (2 column = third column)
		 Locator1.TypeToSearchBox().sendKeys(c1.getStringCellValue()); // Writing Task title
		 Thread.sleep(2000);
			
		
		 if(Locator1.ClickOperation().isEnabled())
	 		{
	 			
	 			Thread.sleep(2000);
	 			Locator1.ClickOperation().click();
	...
	public static void ViewAuditDetailsAddUser( ExtentTest test, XSSFWorkbook workbook) throws InterruptedException
	{
		Thread.sleep(4000);
		...
		Thread.sleep(7000);
		*/
		Locator1.AddUserPlusIcon().click();
		Thread.sleep(3000);
		
		getDriver().switchTo().frame(Locator1.Frame4());
		Thread.sleep(7000);
		
		Locator1.Save2().click();
		Thread.sleep(3000);
			
        String t2 = Locator1.SuccessfullyUser1().getText();				                //Clicking on Dashboard count
        Thread.sleep(2000);
	    ...
	    c1 = row0.getCell(1); // Selected cell (0 row,2 column) (2 column = third column)
	    Locator1.FirstName().sendKeys(c1.getStringCellValue()); // Writing Task title
		Thread.sleep(2000);

	    row0 = sheet.getRow(33);
	    c1 = row0.getCell(1); // Selected cell (0 row,2 column) (2 column = third column)
	    Locator1.LastName().sendKeys(c1.getStringCellValue()); // Writing Task title
		Thread.sleep(2000);

	    row0 = sheet.getRow(34);
	    c1 = row0.getCell(1); // Selected cell (0 row,2 column) (2 column = third column)
	    Locator1.Designation().sendKeys(c1.getStringCellValue()); // Writing Task title
		Thread.sleep(2000);

	    row0 = sheet.getRow(35);
	    c1 = row0.getCell(1); // Selected cell (0 row,2 column) (2 column = third column)
	    Locator1.Email().sendKeys(c1.getStringCellValue()); // Writing Task title
		Thread.sleep(2000);

	    row0 = sheet.getRow(36);
	    c1 = row0.getCell(1); // Selected cell (0 row,2 column) (2 column = third column)
	    Locator1.ContactNo().sendKeys(c1.getStringCellValue()); // Writing Task title
		Thread.sleep(2000);

		Locator1.Save2().click();
		Thread.sleep(3000);
			
        String t1 = Locator1.SuccessfullyUser().getText();				                //Clicking on Dashboard count
        Thread.sleep(2000);
		test.log(LogStatus.PASS,  t1);
 		Thread.sleep(3000);
         
 		if(Locator1.CloseButton().isEnabled())
 		{
 			
 			Thread.sleep(2000);
 			Locator1.CloseButton().click();
		...
		/*
        Locator1.Plus().click();					                //Clicking on Dashboard count
        Thread.sleep(9000);
        ...
        Locator1.Save3().click();					                //Clicking on Dashboard count
        Thread.sleep(17000);

        String t4 = Locator1.Successfull().getText();					                //Clicking on Dashboard count
        Thread.sleep(2000);
        		
 		Thread.sleep(2000);
 		test.log(LogStatus.PASS, " Message Displyed - " + t4 ); 			
        Thread.sleep(2000);
        */
	}
...
*/
 ...
 //       Locator1.OK().click();					                //Clicking on Dashboard count            
  //      Thread.sleep(4000);
	...
	public static void MyWorkspaceFilter( ExtentTest test, XSSFWorkbook workbook) throws InterruptedException
	{
       ...
       Thread.sleep(1000);	
        ...
        Thread.sleep(3000);
		 ...
		 Thread.sleep(3000);
	     String CompanyText =Locator1.CompanyDD1().getText();
	     Thread.sleep(2000);
	     Locator1.CompanyDD1().click();
		 Thread.sleep(20000);
	...
	public static void AddMail( ExtentTest test, XSSFWorkbook workbook) throws InterruptedException
	{
		Thread.sleep(9000);
		/*
		Locator1.ARS().click();
        ...
        Thread.sleep(2000);
       */
        Locator1.NewMail().click();					                //Clicking on Dashboard count
        Thread.sleep(2000);
...
//		Thread.sleep(17000);
	...
	//    Locator1.ViewRemarkAndDocument().click();					                //Clicking on Dashboard count
	//    Thread.sleep(7000);
	    
        if(Locator1.ViewRemarkAndDocument().isEnabled())
 		{
 			
 			Thread.sleep(2000);
 			Locator1.ViewRemarkAndDocument().click();
        ...
        Thread.sleep(3000);
	   if (dirContents1.length < allFilesNew1.length) {
			test.log(LogStatus.PASS,  "Uploaded File Download Successfully");
		}
	   else
	   {
			test.log(LogStatus.FAIL, "Uploaded File does not Download Successfully");
		}

	   Thread.sleep(3000);

        if(Locator1.CloseButtonv().isEnabled())
 		{
 			
 			Thread.sleep(2000);
 			Locator1.CloseButtonv().click();
 			test.log(LogStatus.PASS, "Close Button Working Properly " );
	...
	//		Method1.ForceMail(test,workbook);
	//		Thread.sleep(9000);
	...
	public static void ForceMail( ExtentTest test, XSSFWorkbook workbook) throws InterruptedException
	{
        ...
        Locator1.TODD().click();		//change for this Ambuj			                //Clicking on Dashboard count
        Thread.sleep(2000);
	...
	public static void FilterViewAuditDetails( ExtentTest test, XSSFWorkbook workbook) throws InterruptedException
	{
		...
		Locator1.SelectProcess3().click();
		Thread.sleep(2000);
	    String ProcessText =Locator1.SelectProcess3DD().getText();
	    Thread.sleep(2000);
		Locator1.SelectProcess3DD().click();
		Thread.sleep(20000);

		Locator1.SelectSubProcess3().click();
		Thread.sleep(2000);
	    String SubProcessText =Locator1.SelectSubProcess3DD().getText();
	    Thread.sleep(2000);
		Locator1.SelectSubProcess3DD().click();
		Thread.sleep(20000);
	 ...
	 //     li.add(DocumentText);
		...
		//	filter.add("Period");
			...
			List<WebElement> processcol=getDriver().findElements(By.xpath("//*[@id='ContentPlaceHolder1_grdAuditStatus']/tbody/tr[2]/td[2]"));
			List<WebElement> subprocesscol=getDriver().findElements(By.xpath("//*[@id='ContentPlaceHolder1_grdAuditStatus']/tbody/tr[2]/td[3]"));
	//		List<WebElement> periodcol=getDriver().findElements(By.xpath("//*[@id='ContentPlaceHolder1_grdInternalAudits']/tbody/tr[2]/td[5]"));
	...
	public static void OpenAuditFilter( ExtentTest test, XSSFWorkbook workbook) throws InterruptedException
	{
        ...
        */
		 Locator1.Company().click();
		 Thread.sleep(3000);
	     String CompanyText =Locator1.CompanyDD().getText();
	     Thread.sleep(2000);
	...
	public static void ImplementationAuditFilter( ExtentTest test, XSSFWorkbook workbook) throws InterruptedException
	{
	...
	public static void ClosedAuditFilter( ExtentTest test, XSSFWorkbook workbook) throws InterruptedException
	{
	...
	public static void ClosedAImplementationFilter( ExtentTest test, XSSFWorkbook workbook) throws InterruptedException
	{
	...
	public static void OpenImplementationForceMailAdd( ExtentTest test, XSSFWorkbook workbook) throws InterruptedException
	{
		Thread.sleep(9000);
		/*
		Locator1.ARS().click();
		...
		Thread.sleep(7000);
*/
	    Locator1.OpenImplementationForceMail().click();					                //Clicking on Dashboard count
	    Thread.sleep(20000);
		...
		test.log(LogStatus.PASS, " Add Force Mail - " + t1 );
	...
	public static void ClosedImplementationForceMailAdd( ExtentTest test, XSSFWorkbook workbook) throws InterruptedException
	{
		Thread.sleep(9000);
		/*
		Locator1.ARS().click();
...
//						    Thread.sleep(5000);
	...
	public static void MyDocumentFilter( ExtentTest test, XSSFWorkbook workbook) throws InterruptedException
	{
        ...
        */
		 ...
		 Locator1.FinancialYear().click();
		 Thread.sleep(3000);
		 String FinancialyearText =Locator1.FinancialYearDD().getText();
		 Thread.sleep(2000);
	...
	public static void MyReportFilter( ExtentTest test, XSSFWorkbook workbook) throws InterruptedException
	{
	...
	public static void MyReportObservationReportFilter( ExtentTest test, XSSFWorkbook workbook) throws InterruptedException, IOException
	{
       ...
       Thread.sleep(4000);
		...
		Method1.MyReport(test,workbook);
		Thread.sleep(4000);
		...
		Method1.ObservationReportExportAndGridCount(test,workbook);
		Thread.sleep(5000);
		...
		for(String Fal : fail)
			...
			Method1.MyReportAuditSceduling(test,workbook);
			Thread.sleep(5000);
			
			Method1.MyReportAuditStatus(test,workbook);
			Thread.sleep(5000);
		
			Method1.PrerequisitLogReportFilteer(test,workbook);
			Thread.sleep(5000);
			
			Method1.ManagementResponceLogReportFilteer(test,workbook);
			Thread.sleep(5000);
			
		    Method1.DaftObservationFilter(test,workbook);
		    Thread.sleep(5000);
		
		    Method1.ObservationWordFilter(test,workbook);
		    Thread.sleep(5000);

			Method1.MyReportPastauditReportFilter(test,workbook);
			Thread.sleep(5000);
...
//		Thread.sleep(3000);
        ...
        Thread.sleep(5000);
 		...
 		Method1.AuditStatusNotDoneGridAndExcelCount(test,workbook);
		Thread.sleep(5000);
		
	    Locator1.SubmittedTab().click();					                //Clicking on Dashboard count
	    Thread.sleep(5000);
	        
		Method1.AuditStatusSubmittedGridAndExcelCount(test,workbook);
		Thread.sleep(5000);

	    Locator1.TeamReviewTab().click();					                //Clicking on Dashboard count
	    Thread.sleep(5000);

		Method1.AuditStatusTeamReviewGridAndExcelCount(test,workbook);
		Thread.sleep(5000);

	    Locator1.AuditeeReviewTab().click();					                //Clicking on Dashboard count
	    Thread.sleep(5000);

		Method1.AuditStatusAuditeeReviewGridAndExcelCount(test,workbook);
		Thread.sleep(5000);

	    Locator1.FinalReviewTab().click();					                //Clicking on Dashboard count
	    Thread.sleep(5000);

	    Method1.AuditStatusFinalReviewGridAndExcelCount(test,workbook);
		Thread.sleep(5000);

	    Locator1.ClosedTab().click();					                //Clicking on Dashboard count
	    Thread.sleep(5000);
	    
	    Method1.AuditStatusClosedGridAndExcelCount(test,workbook);
		Thread.sleep(7000);

		Method1.AuditstatusFilter(test,workbook);
		Thread.sleep(7000);
	...
	public static void AuditStatusNotDoneGridAndExcelCount( ExtentTest test, XSSFWorkbook workbook) throws InterruptedException, IOException
	{
        ...
        Thread.sleep(3000);
 	   if (dirContents9.length < allFilesNew0.length) {
 			test.log(LogStatus.PASS,  " Audit Status Report - Export Report Download Successfully");
 		}
 	   else
 	   {
 		 	test.log(LogStatus.FAIL, " Audit Status Report - Export Report Does Not Download Successfully "   );
...
*/
	...
	{
		//test.log(LogStatus.PASS, "No of records from grid matches to no of records in Excel Sheet.");
		test.log(LogStatus.PASS, " Final Review Tab - Total records from Grid = "+length_Row+" | Total records from Report = "+actualRow);
	}
	else
	{
		//test.log(LogStatus.FAIL, "No of records from grid doesn't matches to no of records in Excel Sheet.");
		test.log(LogStatus.FAIL, " Final Review Tab - Total records from Grid = "+length_Row+" | Total records from Excel Sheet = "+actualRow);
	}
...
*/
	...
	*/
	...
	public static void PastAuditFilter( ExtentTest test, XSSFWorkbook workbook) throws InterruptedException, IOException
	{
       ...
       Thread.sleep(4000);
        ...
        Thread.sleep(6000);
		 ...
		 Locator1.FinancialYearPastAudit().click();
		 Thread.sleep(3000);
		 String FinancialyearText =Locator1.FinancialYearMReportDD().getText();
		 Thread.sleep(2000);
		 Locator1.FinancialYearMReportDD().click();
		 ...
		 Locator1.AuditBackground1().click();
	     Thread.sleep(2000);
		 String AuditbackgroundText =Locator1.AuditBackgroundDD().getText();
		 Thread.sleep(2000);
	     Locator1.AuditBackgroundDD().click();
		 Thread.sleep(20000);
	...
	//		List<WebElement> statuscol=getDriver().findElements(By.xpath("//*[@id='ContentPlaceHolder1_grdSummaryDetailsAuditCoverage']/tbody/tr[2]/td[9]"));
		...
		for(String Fal : fail)
	        ...
	        if(Locator1.SearchBox().isEnabled())
	 		{
	 			
		        row0 = sheet.getRow(50);
				c1 = row0.getCell(1); // Selected cell (0 row,2 column) (2 column = third column)
				Locator1.SearchBox().sendKeys(c1.getStringCellValue()); // Writing Task title
				Thread.sleep(2000);
...
//		Thread.sleep(3000);
	 ...
	 */
	        ...
	        Thread.sleep(3000);
	 	   if (dirContents9.length < allFilesNew0.length) {
	 			test.log(LogStatus.PASS,  " Word Document Download Successfully");
	 		}
	 	   else
	 	   {
	 		 	test.log(LogStatus.FAIL, "  Word Document Does Not Download Successfully "   );
	...
	//	Locator.ARS().click();
		...
		Thread.sleep(4000);
	        ...
	        Thread.sleep(5000);
			 ...
			 Locator1.SelectProcess4().click();
			 Thread.sleep(3000);
			 String processText =Locator1.SelectProcess4DD().getText();
			 Thread.sleep(2000);
			 Locator1.SelectProcess4DD().click();
			 Thread.sleep(20000);
			
     
		 Locator1.SelectSubProcess4().click();
		 Thread.sleep(3000);
	     String subprocessText =Locator1.SelectSubProcess4DD().getText();
	     Thread.sleep(2000);
	     Locator1.SelectSubProcess4DD().click();
		 Thread.sleep(20000);
		 ...
		 Thread.sleep(20000);
	      ...
	      Thread.sleep(3000);
			...
			List<WebElement> unitcol=getDriver().findElements(By.xpath("//*[@id='ContentPlaceHolder1_grdARSReport']/tbody/tr[2]/td[3]"));
			List<WebElement> financialyearcol=getDriver().findElements(By.xpath("//*[@id='ContentPlaceHolder1_grdARSReport']/tbody/tr[2]/td[5]"));
			List<WebElement> periodcol=getDriver().findElements(By.xpath("//*[@id='ContentPlaceHolder1_grdARSReport']/tbody/tr[2]/td[6]"));
			List<WebElement> processcol=getDriver().findElements(By.xpath("//*[@id='ContentPlaceHolder1_grdARSReport']/tbody/tr[2]/td[7]"));
			List<WebElement> subprocesscol=getDriver().findElements(By.xpath("//*[@id='ContentPlaceHolder1_grdARSReport']/tbody/tr[2]/td[8]"));
