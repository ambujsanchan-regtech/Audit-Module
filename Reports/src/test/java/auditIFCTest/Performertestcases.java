...
public class Performertestcases extends BasePage{
...
//	public static WebDriver driver = null;		//WebDriver instance created
		...
		
	{
		...
		//fis = new FileInputStream("D:\\AuditARSReportingTesting\\TestData\\TestData.xlsx");
	...
	void setBrowser() throws Exception
	{
		...
		extent = new com.relevantcodes.extentreports.ExtentReports("D:\\AuditARSReportingTesting\\Reports\\PerformerArsTest.html",true);
		test = extent.startTest("Verify OpenBrowser");
		
		test.log(LogStatus.PASS, "Test Passed - Performer Login");
		extent.endTest(test);
		extent.flush();
	}
...
*/
	...
	void OpenAudit1() throws InterruptedException, IOException
	{
		...
		Method1.OpenAudit(test,workbook);
	...
	void OpenImplementation1() throws InterruptedException, IOException
	{
		...
		Method1.OpenImplementation(test,workbook);
	...
	void ClosedAudit1() throws InterruptedException, IOException
	{
		...
		Method1.ClosedAudit(test,workbook);
	...
	void ClosedImplementation1() throws InterruptedException, IOException
	{
		...
		Method1.ClosedImplementation(test,workbook);
	...
	void AddStartDateEndDate1() throws InterruptedException, IOException
	{
		...
		Method1.AddStartDateEndDate(test,workbook);
	...
	void AddCheckBoxAndSendMail1() throws InterruptedException, IOException
	{
		...
		Method1.AddCheckBoxAndSendMail(test,workbook);
	...
	void AddPrerequisiteFilter1() throws InterruptedException, IOException
	{
		...
		Method1.AddPrerequisiteFilter(test,workbook);
	...
	void ViewDataRequestFilter1() throws InterruptedException, IOException
	{
		...
		Method1.ViewDataRequestFilter(test,workbook);
	...
	void AddDocument1() throws InterruptedException, IOException
	{
		...
		Method1.AddDocument(test,workbook);
	...
	void AddObservation1() throws InterruptedException, IOException
	{
		...
		Method1.AddObservation(test,workbook);
	...
	@Test(priority = 12) //not working
	void AddMail1() throws InterruptedException, IOException
	{
		test = extent.startTest("My Workspace - View Audit Details - Add New Mail Verification ");
	...
	void DraftObservationListing1() throws InterruptedException, IOException
	{
		...
		Method1.DraftObservationListing(test,workbook);
	...
	void InternalAuditMeeting1() throws InterruptedException, IOException
	{
		...
		Method1.InternalAuditMeeting(test,workbook);
	...
	@Test(priority = 15) 
	void FilterViewAuditDetails1() throws InterruptedException, IOException
	{
		test = extent.startTest("My Workspace - View Audit Details - Audit Status Summary Page - Multiple Filter Verification ");
		
		Method1.FilterViewAuditDetails(test,workbook);
	...
	@Test(priority = 16) 
	void MyWorkspaceFilter1() throws InterruptedException, IOException
	{
		test = extent.startTest("My Workspace - Multiselection Filter Verification ");
		
		Method1.MyWorkspaceFilter(test,workbook);
	...
	void MyReport1() throws InterruptedException, IOException
	{
		test = extent.startTest("My Report - Report Upload And Downloads Verification ");
	...
	void MyReportObservationReportFilter1() throws InterruptedException, IOException
	{
		...
		Method1.MyReportObservationReportFilter(test,workbook);
	...
	@Test(priority = 21) // working
	void ViewDocument1() throws InterruptedException, IOException
	{
		test = extent.startTest("My Workspace - View Document and remark Verification ");
	...
	//@Test(priority = 22) //not working
	void AuditstatusFilter1() throws InterruptedException, IOException
	{
		test = extent.startTest("My Report - Audit Status Report Verification ");
