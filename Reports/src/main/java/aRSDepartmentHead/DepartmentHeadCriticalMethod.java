...
public class DepartmentHeadCriticalMethod extends BasePage{
...
//						    Thread.sleep(5000);
					...
					//	   DepartmentHeadMethod.MyDocumentFilter(test,workbook);
					//		Thread.sleep(5000);
...
*/
	...
	*/
		...
		for(String Fal : fail)
			 {
					test.log(LogStatus.FAIL, "Key - " + filter.get(i)+" column shows incorrect value : "+Fal);
			 }	
			 for(String Pas : pass)
			 {
				 test.log(LogStatus.PASS, "Key - " +  filter.get(i)+" dropdown working properly.");
					test.log(LogStatus.PASS, filter.get(i)+" displayed : "+Pas);	
					System.out.println(filter.get(i)+" : "+Pas);
		 }
			 text.clear();
