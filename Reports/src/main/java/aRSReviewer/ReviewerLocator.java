...
public class ReviewerLocator extends BasePage{
	...
	public static WebElement ViewDataRequestDetails() {
		...
		ViewDataRequestDetails=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_grdRiskActivityMatrix_lnkprerequsiteDetails_0']/img"));
...
public static WebElement Submit() {
	...
	Submit=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_grdAuditStatus_lblRiskCompleted_1']"));
		return Submit;
	}
...
public static WebElement NextButton3() {
	...
	static WebElement clickselectprocess() {
	...
	public static WebElement clickcheckboox() {
		checkboox=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_grdSummaryDetailsAuditCoverage_CheckBox1_0']"));
		return checkboox;
	}
...
public static WebElement SelectProcess1DD() {
	...
	ARS=getDriver().findElement(By.xpath("(//li[.='hub office'])[1]"));
	return ARS;
}
