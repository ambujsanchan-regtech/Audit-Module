...
public class Locator1 extends BasePage{
	...
	private static WebElement NewMailButton1 = null;
	...
	private static WebElement DraftExportToExcel = null;
	private static WebElement EyeIcon = null;
	...
	private static WebElement DeleteDraft = null;
	private static WebElement BackButton1 = null;
	...
	private static WebElement AddUserPlusIcon = null;
	private static WebElement Frame4 = null;
	...
	private static WebElement SuccessfullyUser = null;
	private static WebElement SuccessfullyUser1 = null;
	private static WebElement CloseButton = null;
	private static WebElement ForceMail = null;
	private static WebElement AddDocumentAndRemark = null;
	private static WebElement Frame5 = null;

	
	private static WebElement Plus = null;
	private static WebElement DocumentName1 = null;
	private static WebElement Save3 = null;
	private static WebElement Successfull = null;
	private static WebElement CloseP = null;
	private static WebElement AuditDD = null;
	private static WebElement ReportingManager = null;
	private static WebElement Timeline = null;
	private static WebElement TimelineDD = null;
	private static WebElement ChooseFile = null;
	private static WebElement Save5 = null;
	private static WebElement Successfully5 = null;
	private static WebElement CloseButton5 = null;
	private static WebElement Deletefile = null;
	private static WebElement Successfully4 = null;
	private static WebElement Save7 = null;	
	private static WebElement Successfully7 = null;
	...
	private static WebElement SelectProcess1DD = null;
	private static WebElement SelectSubProcess1 = null;
	private static WebElement SelectSubProcess1DD = null;
	private static WebElement Audtee = null;	
	private static WebElement AudteeDD = null;
	private static WebElement ReportingManager1 = null;
	private static WebElement ReportingManager1DD = null;
	...
	private static WebElement CheckBox1 = null;
	private static WebElement Remark = null;
	private static WebElement Savebutton = null;
	private static WebElement Successfullmessage = null;	
	private static WebElement SelectProcess3 = null;
	private static WebElement SelectProcess3DD = null;
	private static WebElement SelectSubProcess3 = null;
	private static WebElement SelectSubProcess3DD = null;
	...
	private static WebElement OpenImplementationForceMail = null;
	...
	private static WebElement ViewFile = null;
	private static WebElement DownloadFile = null;
	...
	private static WebElement MoreReportOpenObservationReport = null;	
	private static WebElement MROpenObservationReportExportReport = null;
	private static WebElement MROpenObservationCompany = null;
	private static WebElement MROpenObservationCompanyDD = null;
	private static WebElement FinancialYearMReport = null;
	private static WebElement FinancialYearMReportDD = null;
	private static WebElement SelectSchedulingType = null;
	private static WebElement SelectSchedulingTypeDD = null;
	...
	private static WebElement AuditSchedulingExportToExcelButton = null;
	private static WebElement AuditStatus = null;
	private static WebElement AuditStatusExportToExcelButton = null;
	private static WebElement NotDoneTab = null;
	private static WebElement SubmittedTab = null;
	private static WebElement TeamReviewTab = null;
	private static WebElement AuditeeReviewTab = null;
	private static WebElement FinalReviewTab = null;
	private static WebElement ClosedTab = null;
	private static WebElement CheckBox2 = null;
	private static WebElement Save4 = null;
	private static WebElement SuccessfullyObservation1 = null;
	private static WebElement WorkingDocument1 = null;
	private static WebElement AnnexureDocument1 = null;
	private static WebElement View2 = null;
	private static WebElement Close4 = null;
	private static WebElement GridPage = null;
	private static WebElement GridPageDD = null;

	private static WebElement PreRequisiteLogReport = null;
	private static WebElement FinancialYearp = null;
	private static WebElement SchedulingTypeP = null;
	private static WebElement SchedulingTypePDD = null;
	private static WebElement Periodp = null;
	private static WebElement PeriodpDD = null;
	...
	private static WebElement PastAuditReports = null;
	...
	private static WebElement FinancialYearPastAudit = null;
	...
	private static WebElement ViewIcon = null;
	private static WebElement UnitD = null;
	private static WebElement FinancialYearD = null;
	private static WebElement ObservationWord = null;
	private static WebElement ExportObservationWord = null;	
	private static WebElement Submitted = null;
	private static WebElement BackButtonS = null;
	private static WebElement ViewRemarkAndDocument = null;	
	private static WebElement DownloadLink = null;
	private static WebElement CloseButtonv = null;

	private static WebElement SelectProcess4 = null;
	private static WebElement SelectProcess4DD = null;	
	private static WebElement SelectSubProcess4 = null;
	private static WebElement SelectSubProcess4DD = null;
	...
	public static WebElement StartDate() {
		...
		StartDate=getDriver().findElement(By.xpath("//input[@id='ContentPlaceHolder1_grdRiskActivityMatrix_txtStartDate_6']"));
		return StartDate;
	}
	...
	public static WebElement EndDate() {
		...
		EndDate=getDriver().findElement(By.xpath("//input[@id='ContentPlaceHolder1_grdRiskActivityMatrix_txtEndDate_6']"));
		return EndDate;
	}
	...
	public static WebElement SaveAuditDateDetail() {
		...
		SaveAuditDateDetail=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_grdRiskActivityMatrix_lnkSave_6']/img"));
	...
	public static WebElement ViewAuditDetails() {
		...
		ViewAuditDetails=getDriver().findElement(By.xpath("//*[@id='grd_csa']/div[2]/table/tbody/tr[1]/td[6]/a[3]/img"));
	...
	public static WebElement NotDone() {
		...
		NotDone=getDriver().findElement(By.xpath("//*[@id='grd_csa']/div[2]/table/tbody/tr[1]/td[4]/a"));
		return NotDone;
	}
	...
	public static WebElement ChangeStatus() {
		...
		ChangeStatus=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_grdSummaryDetailsAuditCoverage_btnChangeStatus_0']/img"));
		return ChangeStatus;
	}
	...
	public static WebElement ProcessWalkthrogh() {
		...
		ProcessWalkthrogh=getDriver().findElement(By.xpath("//*[@id=\"txtWalkthrough\"]"));
	...
	public static WebElement OwnerNameDD() {
		...
		OwnerNameDD=getDriver().findElement(By.xpath("//*[@id='ddlOwnerName_listbox']/li[14]"));
		return OwnerNameDD;
	}
	...
	public static WebElement CompanyDD() {
		...
		CompanyDD=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_ddlLegalEntity_chosen']/div/ul/li[1]"));
		return CompanyDD;
	}
	...
	public static WebElement AddNew() {
		...
		AddNew=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_btnAddChecklist']"));
		return AddNew;
	}
	...
	public static WebElement OK() {
		...
		OK=getDriver().findElement(By.xpath("(//button[@class='k-button k-primary'])[3]"));
		return OK;
	}
	...
	public static WebElement ExportToExcel() {
		...
		ExportToExcel=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_upAuditStatusSummary']/div/div/div/section/div[2]/div[2]/div[3]/button"));
		//*[@id="ContentPlaceHolder1_upAuditStatusSummary"]/div/div/div/section/div[2]/div[2]/div[3]/button
	...
	public static WebElement NewMail() {
		...
		NewMail=getDriver().findElement(By.xpath("//a[@id='ContentPlaceHolder1_lnkClosingMeeting']"));
		return NewMail;
	}
	...
	*/
	...
	public static WebElement NewMailButton1() {
		...
		NewMailButton1=getDriver().findElement(By.xpath("//form/div[9]/div/div/div[2]/div/div/div[1]/div/button[@id='btnNewMail']"));
		return NewMailButton1;
	}
	...
	public static WebElement TODD() {
		...
		TODD=getDriver().findElement(By.xpath("//*[@id='email_listbox']/li[7]"));
	...
	public static WebElement DraftExportToExcel() {
		...
		DraftExportToExcel=getDriver().findElement(By.xpath("//a[@id='ContentPlaceHolder1_lblExport']"));
		return DraftExportToExcel;
	}

	
	public static WebElement EyeIcon() {
		
		EyeIcon=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_grdObservationList_lnkViewAudit_0']/img"));
	...
	public static WebElement Export() {
		...
		Export=getDriver().findElement(By.xpath("//a[@id='ContentPlaceHolder1_lblExport']"));
		return Export;
	}
	...
	public static WebElement Back() {
		...
		Back=getDriver().findElement(By.xpath("//a[@id='ContentPlaceHolder1_btnBack']"));
		return Back;
	}
	...
	public static WebElement DeleteDraft() {
		...
		DeleteDraft=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_grdObservationList_lnkAuditDetails_0']/img"));
		return DeleteDraft;
	}
	...
	public static WebElement BackButton1() {
		...
		BackButton1=getDriver().findElement(By.xpath("//a[@id='ContentPlaceHolder1_btnBack']"));
		return BackButton1;
	}
	...
	public static WebElement InternalAuditMeeting() {
		...
		InternalAuditMeeting=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_grdRiskActivityMatrix_lnkClosingMeeting_0']/img"));
	...
	public static WebElement AddUserPlusIcon() {
		...
		AddUserPlusIcon=getDriver().findElement(By.xpath("//img[@id='lnkAddNewUser']"));
		return AddUserPlusIcon;
	}
	...
	public static WebElement Frame4() {
		...
		Frame4=getDriver().findElement(By.xpath("//iframe[@id='IUser']"));
		return Frame4;
	}
	...
	public static WebElement Save2() {
		...
		Save2=getDriver().findElement(By.xpath("//div[@id='upUsers']//input[@id='btnSave' and @class='btn btn-primary']"));
		return Save2;
	}
	...
	public static WebElement SuccessfullyUser() {
		...
		SuccessfullyUser=getDriver().findElement(By.xpath("//*[@id='ValidationSummary15']/ul/li"));
		return SuccessfullyUser;
	}

	
	public static WebElement SuccessfullyUser1() {
		
		SuccessfullyUser1=getDriver().findElement(By.xpath("//*[@id='ValidationSummary15']/ul"));
		return SuccessfullyUser1;
	}
	...
	public static WebElement CloseButton() {
		...
		CloseButton=getDriver().findElement(By.xpath("//div[@id='upUsers']//input[@id='btnCancel']"));
		return CloseButton;
	}
	...
	public static WebElement AddDocumentAndRemark() {
		...
		AddDocumentAndRemark=getDriver().findElement(By.xpath("//*[@id='grdProcessAudit_LinkButton3_0']/img"));
		//*[@id="grdProcessAudit_LinkButton3_0"]/img
		return AddDocumentAndRemark;
	}

	
	public static WebElement Frame5() {
		
		Frame5=getDriver().findElement(By.xpath("//iframe[@id='Preshowdetails']"));
		return Frame5;
	}
	...
	public static WebElement Plus() {
		...
		Plus=getDriver().findElement(By.xpath("//*[@id='grdProcessAudit_LinkButton1_0']/img"));
		return Plus;
	}
	...
	public static WebElement DocumentName1() {
		...
		DocumentName1=getDriver().findElement(By.xpath("//input[@id='tbxCheckListName']"));
	...
	public static WebElement Save3() {
		...
		Save3=getDriver().findElement(By.xpath("//input[@id='btnAddCheckList']"));
		return Save3;
	}
	...
	public static WebElement Successfull() {
		...
		Successfull=getDriver().findElement(By.xpath("//*[@id='ValidationSummary1']/ul/li"));
		return Successfull;
	}
	...
	public static WebElement CloseP() {
		...
		CloseP=getDriver().findElement(By.xpath("//*[@id='divCheckListAdd']/div/div/div[1]/button"));
		return CloseP;
	}
	...
	public static WebElement AuditDD() {
		...
		AuditDD=getDriver().findElement(By.xpath("//select[@id='grdProcessAudit_ddlPerformer_0']/option[2]"));
		return AuditDD;
	}
	...
	public static WebElement ReportingManager() {
		...
		ReportingManager=getDriver().findElement(By.xpath("//select[@id='grdProcessAudit_ddlReviewer_0']/option[2]"));
	...
	public static WebElement Timeline() {
		...
		Timeline=getDriver().findElement(By.xpath("//input[@id='txtStartDateKickoff']"));
		return Timeline;
	}
	...
	public static WebElement TimelineDD() {
		...
		TimelineDD=getDriver().findElement(By.xpath("//a[.='25']"));
		return TimelineDD;
	}
	...
	public static WebElement ChooseFile() {
		...
		ChooseFile=getDriver().findElement(By.xpath("//input[@id='fileUploadDocument']"));
		return ChooseFile;
	}
	...
	public static WebElement Save5() {
		...
		Save5=getDriver().findElement(By.xpath("//input[@id='btnSaveRemarkDoc']"));
		return Save5;
	}
	...
	public static WebElement Successfully5() {
		...
		Successfully5=getDriver().findElement(By.xpath("//*[@id='ValidationSummary2']/ul/li"));
		return Successfully5;
	}

	
	public static WebElement CloseButton5() {
		
		CloseButton5=getDriver().findElement(By.xpath("//input[@id='btnCancel']"));
		return CloseButton5;
	}
	...
	public static WebElement Deletefile() {
		...
		Deletefile=getDriver().findElement(By.xpath("//*[@id='rptComplianceDocumnets_lbtLinkDocbutton_0']/img"));
		return Deletefile;
	}
	...
	public static WebElement Successfully4() {
		...
		Successfully4=getDriver().findElement(By.xpath("//*[@id='ValidationSummary2']/ul/li"));
		return Successfully4;
	}
	...
	public static WebElement Save7() {
		...
		Save7=getDriver().findElement(By.xpath("//input[@id='btnSave']"));
		return Save7;
	}
	...
	public static WebElement Successfully7() {
		...
		Successfully7=getDriver().findElement(By.xpath("//*[@id='ValidationSummary3']/ul/li"));
		return Successfully7;
	}
	...
	public static WebElement SelectProcess1() {
		...
		SelectProcess1=getDriver().findElement(By.xpath("//*[@id='ddlProcess1_chosen']"));
	...
	public static WebElement SelectProcess1DD() {
		...
		SelectProcess1DD=getDriver().findElement(By.xpath("(//li[.='hub office'])[1]"));
		return SelectProcess1DD;
	}


	public static WebElement SelectSubProcess1() {
		
		SelectSubProcess1=getDriver().findElement(By.xpath("//*[@id='ddlSubProcess1_chosen']"));
		return SelectSubProcess1;
	}


	public static WebElement SelectSubProcess1DD() {
		
		SelectSubProcess1DD=getDriver().findElement(By.xpath("//li[.='ARS Audit Two']"));
		return SelectSubProcess1DD;
	}

	
	public static WebElement Audtee() {
		
		Audtee=getDriver().findElement(By.xpath("//*[@id='ddlPerformerFilter_chosen']"));
		return Audtee;
	}
	...
	public static WebElement AudteeDD() {
		...
		AudteeDD=getDriver().findElement(By.xpath("//*[@id='ddlPerformerFilter_chosen']/div/ul/li[2]"));
		//*[@id="ddlPerformerFilter_chosen"]/div/ul/li[2]
		return AudteeDD;
	}
	...
	public static WebElement ReportingManager1() {
		...
		ReportingManager1=getDriver().findElement(By.xpath("//*[@id='ddlReviewerFilter_chosen']"));
	...
	public static WebElement ReportingManager1DD() {
		...
		ReportingManager1DD=getDriver().findElement(By.xpath("//*[@id='ddlReviewerFilter_chosen']/div/ul/li[3]"));
		return ReportingManager1DD;
	}
	...
	public static WebElement SelectProcess2DD() {
		...
		SelectProcess2DD=getDriver().findElement(By.xpath("//div[@id='ddlProcess_chosen']//li[.='hub office']"));
	...
	public static WebElement SelectSubProcess2DD() {
		...
		SelectSubProcess2DD=getDriver().findElement(By.xpath("//li[.='ARS Audit Two']"));
	...
	public static WebElement CheckBox1() {
		...
		CheckBox1=getDriver().findElement(By.xpath("//*[@id='grd_csa']/div[2]/table/tbody/tr[1]/td[1]/input"));
		return CheckBox1;
	}
	...
	public static WebElement Remark() {
		...
		Remark=getDriver().findElement(By.xpath("//*[@id='remarks']"));
		//("//input[@id='ContentPlaceHolder1_grdSummaryDetailsAuditCoverage_txtRemark_0']"));
		return Remark;
	}
	...
	public static WebElement Savebutton() {
		...
		Savebutton=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_btnSave']"));
		return Savebutton;
	}

	
	
	public static WebElement Successfullmessage() {
		
		Successfullmessage=getDriver().findElement(By.xpath("//*[@id='confirmbox']/p1/strong"));
		//("//*[@id='ContentPlaceHolder1_ValidationSummary1']/ul/li"));
		return Successfullmessage;
	}

	
	public static WebElement SelectProcess3() {
		
		SelectProcess3=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_ddlProcess_chosen']"));
		return SelectProcess3;
	}

	
	
	public static WebElement SelectProcess3DD() {
		
		SelectProcess3DD=getDriver().findElement(By.xpath("//li[.='Contract and Report']"));
		return SelectProcess3DD;
	}

	
	public static WebElement SelectSubProcess3() {
		
		SelectSubProcess3=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_ddlSubProcess_chosen']"));
		return SelectSubProcess3;
	}

		
	public static WebElement SelectSubProcess3DD() {
		
		SelectSubProcess3DD=getDriver().findElement(By.xpath("//li[.='ARS Audit Two']"));
		return SelectSubProcess3DD;
	}
	...
	public static WebElement AnnexureFileDelete() {
		...
		AnnexureFileDelete=getDriver().findElement(By.xpath("//a[@class='k-button k-button-icontext ob-delete k-grid-delete']"));
		return AnnexureFileDelete;
	}


	
	public static WebElement OpenImplementationForceMail() {
		
		OpenImplementationForceMail=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_grdRiskActivityMatrix_lnkClosingMeeting_0']/img"));
		return OpenImplementationForceMail;
	}
	...
	public static WebElement ViewFile() {
		...
		ViewFile=getDriver().findElement(By.xpath("(//a[@role='button'])[13]"));
		return ViewFile;
	}
	...
	public static WebElement DownloadFile() {
		...
		DownloadFile=getDriver().findElement(By.xpath("(//a[@role='button'])[14]"));
		return DownloadFile;
	}
	...
	public static WebElement DownloadButton() {
		...
		DownloadButton=getDriver().findElement(By.xpath("//a[@id='ContentPlaceHolder1_grdSummaryDetailsAuditCoverage_lblDocumentDownLoadfile_0']"));
	...
	public static WebElement FinancialYearDD() {
		...
		FinancialYearDD=getDriver().findElement(By.xpath("//li[.='2024-2025']"));
	...
	public static WebElement AllFileDownloadButton5() {
		//*[@id="ContentPlaceHolder1_grdSummaryDetailsAuditCoverage_lblDocumentDownLoadfileActionAll_0"]
		AllFileDownloadButton5=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_grdSummaryDetailsAuditCoverage_lblDocumentDownLoadfileActionAll_0']"));
	...
	public static WebElement MoreReport() {
		...
		MoreReport=getDriver().findElement(By.xpath("//*[@id='rblRole1']/li[2]/div//button"));
	...
	public static WebElement MoreReportOpenObservationReport() {
		...
		MoreReportOpenObservationReport=getDriver().findElement(By.xpath("(//*[@id='rblRole1']/li[2]/div/ul/li[.='Open Observation-Excel'])[1]"));
		return MoreReportOpenObservationReport;
	}


	public static WebElement MROpenObservationReportExportReport() {
		
		MROpenObservationReportExportReport=getDriver().findElement(By.xpath("//input[@id='ContentPlaceHolder1_lbtnExportExcel']"));
		return MROpenObservationReportExportReport;
	}
	...
	public static WebElement MROpenObservationCompany() {
		...
		MROpenObservationCompany=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_ddlLegalEntity_chosen']"));
		return MROpenObservationCompany;
	}
	...
	public static WebElement MROpenObservationCompanyDD() {
		...
		MROpenObservationCompanyDD=getDriver().findElement(By.xpath("//*[@id=\"ddlLegalEntityPopPup_chosen\"]/div/ul/li[20]"));
		//*[@id="ddlLegalEntityPopPup_chosen"]/div/ul/li[20]
	...
	public static WebElement FinancialYearMReport() {
		...
		FinancialYearMReport=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_ddlFinancialYear_chosen']"));
		return FinancialYearMReport;
	}


	public static WebElement FinancialYearMReportDD() {
		
		FinancialYearMReportDD=getDriver().findElement(By.xpath("//li[.='2024-2025']"));
	...
	public static WebElement SelectSchedulingType() {
		...
		SelectSchedulingType=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_ddlSchedulingType_chosen']"));
	...
	public static WebElement SelectSchedulingTypeDD() {
		...
		SelectSchedulingTypeDD=getDriver().findElement(By.xpath("//li[.='Half Yearly']"));
		return SelectSchedulingTypeDD;
	}
	...
	public static WebElement PeriodDD() {
		...
		PeriodDD=getDriver().findElement(By.xpath("//li[.='Apr-Sep']"));
		return PeriodDD;
	}
	...
	public static WebElement AuditScheduling() {
		...
		AuditScheduling=getDriver().findElement(By.xpath("//*[@id='rblRole1']/li[2]/div/ul/li[2]"));
	...
	public static WebElement AuditSchedulingExportToExcelButton() {
		...
		AuditSchedulingExportToExcelButton=getDriver().findElement(By.xpath("//a[@id='ContentPlaceHolder1_lbtnExportExcel']"));
		return AuditSchedulingExportToExcelButton;
	}
	...
	public static WebElement AuditStatus() {
		...
		AuditStatus=getDriver().findElement(By.xpath("//*[@id='rblRole1']/li[2]/div/ul/li[3]"));
		return AuditStatus;
	}
	...
	public static WebElement AuditStatusExportToExcelButton() {
		...
		AuditStatusExportToExcelButton=getDriver().findElement(By.xpath("//a[@id='ContentPlaceHolder1_btnExportExcel']"));
		return AuditStatusExportToExcelButton;
	}

	
	public static WebElement NotDoneTab() {
		
		NotDoneTab=getDriver().findElement(By.xpath("//a[@id='ContentPlaceHolder1_btnNotDone']"));
		return NotDoneTab;
	}
	...
	public static WebElement SubmittedTab() {
		...
		SubmittedTab=getDriver().findElement(By.xpath("//a[@id='ContentPlaceHolder1_btnSubmitted']"));
		return SubmittedTab;
	}
	...
	public static WebElement TeamReviewTab() {
		...
		TeamReviewTab=getDriver().findElement(By.xpath("//a[@id='ContentPlaceHolder1_btnTeamReview']"));
		return TeamReviewTab;
	}

	
	public static WebElement AuditeeReviewTab() {
		
		AuditeeReviewTab=getDriver().findElement(By.xpath("//a[@id='ContentPlaceHolder1_btnAuditee']"));
		return AuditeeReviewTab;
	}

	
	public static WebElement FinalReviewTab() {
		
		FinalReviewTab=getDriver().findElement(By.xpath("//a[@id='ContentPlaceHolder1_btnFinalReview']"));
		return FinalReviewTab;
	}


	public static WebElement ClosedTab() {
		
		ClosedTab=getDriver().findElement(By.xpath("//a[@id='ContentPlaceHolder1_btnClosed']"));
		return ClosedTab;
	}
	...
	public static WebElement CheckBox2() {
		...
		CheckBox2=getDriver().findElement(By.xpath("//input[@id='ContentPlaceHolder1_grdObservationList_CheckBox1_0']"));
		return CheckBox2;
	}

	public static WebElement Save4() {
		
		Save4=getDriver().findElement(By.xpath("//input[@id='ContentPlaceHolder1_btnSave']"));
		return Save4;
	}
	...
	public static WebElement SuccessfullyObservation1() {
		...
		SuccessfullyObservation1=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_ValidationSummary1']/ul/li"));
		return SuccessfullyObservation1;
	}
	...
	public static WebElement WorkingDocument1() {
		...
		WorkingDocument1=getDriver().findElement(By.xpath("//a[@class='k-button k-button-icontext ob-download k-grid-download']"));
		return WorkingDocument1;
	}

	
	public static WebElement AnnexureDocument1() {
		
		AnnexureDocument1=getDriver().findElement(By.xpath("(//a[@class='k-button k-button-icontext ob-download k-grid-download'])[5]"));
		return AnnexureDocument1;
	}
	...
	public static WebElement View2() {
		...
		View2=getDriver().findElement(By.xpath("//a[@class='k-button k-button-icontext obs-show k-grid-view']"));
		return View2;
	}
	...
	public static WebElement Close4() {
		...
		Close4=getDriver().findElement(By.xpath("//*[@id='divPreShowDialog']/div/div/div[1]/button[.='×']"));
		return Close4;
	}
	...
	public static WebElement GridPage() {
		...
		GridPage=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_DropDownListPageNo_chosen']"));
		return GridPage;
	}
	...
	public static WebElement GridPageDD() {
		...
		GridPageDD=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_DropDownListPageNo_chosen']/div/ul/li[2]"));
		return GridPageDD;
	}

	public static WebElement PreRequisiteLogReport() {
		
		PreRequisiteLogReport=getDriver().findElement(By.xpath("//*[@id='rblRole1']/li[2]/div/ul/li[4]"));
	...
	public static WebElement FinancialYearp() {
		...
		FinancialYearp=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_ddlFilterFinancial_chosen']"));
		return FinancialYearp;
	}

	
	public static WebElement SchedulingTypeP() {
		
		SchedulingTypeP=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_ddlSchedulingType_chosen']"));
		return SchedulingTypeP;
	}
	...
	public static WebElement SchedulingTypePDD() {
		...
		SchedulingTypePDD=getDriver().findElement(By.xpath("//li[.='Quarterly']"));
		return SchedulingTypePDD;
	}
	...
	public static WebElement Periodp() {
		...
		Periodp=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_ddlPeriod_chosen']"));
		return Periodp;
	}
	...
	public static WebElement PeriodpDD() {
		...
		PeriodpDD=getDriver().findElement(By.xpath("//li[.='Apr-Jun']"));
		return PeriodpDD;
	}
	...
	public static WebElement ManagementResponcelogreport() {
		...
		ManagementResponcelogreport=getDriver().findElement(By.xpath("//*[@id='rblRole1']/li[2]/div/ul/li[5]"));
	...
	public static WebElement PastAuditReports() {
		...
		PastAuditReports=getDriver().findElement(By.xpath("//*[@id='rblRole1']/li[2]/div/ul/li[6]"));
		return PastAuditReports;
	}
	...
	public static WebElement AuditBackgroundDD() {
		//*[@id="ddlAuditBackground_chosen"]/div/ul/li[2]
		//*[@id='ddlAuditBackground_chosen']/a/span
		AuditBackgroundDD=getDriver().findElement(By.xpath("//*[@id='ddlAuditBackground_chosen']/div/ul/li[2]"));
	...
	public static WebElement ReportGenerationDateDD() {
		...
		ReportGenerationDateDD=getDriver().findElement(By.xpath("//a[.='25']"));
	...
	public static WebElement CloseButton1() {
		...
		CloseButton1=getDriver().findElement(By.xpath("//*[@id='btnCancel']"));
		//*[@id="btnCancel"]
		return CloseButton1;
	}
	...
	public static WebElement DownloadButton1() {
		...
		DownloadButton1=getDriver().findElement(By.xpath("//*[@id='grdVersionDisplayDownload_lblDownLoadfile_0']/img"));
	...
	public static WebElement ViewButton() {
		...
		ViewButton=getDriver().findElement(By.xpath("//*[@id='grdVersionDisplayDownload_LinkButton1_0']"));
		
		//*[@id="grdVersionDisplayDownload_LinkButton1_0"]
		return ViewButton;
	}
	...
	public static WebElement ClosePopup() {
		//*[@id="btnCancel"]
		ClosePopup=getDriver().findElement(By.xpath("//*[@id='btnCancel']"));
	...
	public static WebElement FinancialYearPastAudit() {
		...
		FinancialYearPastAudit=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_ddlFilterFinancial_chosen']"));
		return FinancialYearPastAudit;
	}
	...
	public static WebElement DraftObservation() {
		...
		DraftObservation=getDriver().findElement(By.xpath("//*[@id='rblRole1']/li[2]/div/ul/li[2]/a"));
	...
	public static WebElement ViewIcon() {
		...
		ViewIcon=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_grdProcessAudits_lnkAuditDetails_0']/img"));
		return ViewIcon;
	}
	...
	public static WebElement UnitD() {
		...
		UnitD=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_ddlLegalEntity_chosen']"));
		return UnitD;
	}
	...
	public static WebElement FinancialYearD() {
		...
		FinancialYearD=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_ddlFinancialYear_chosen']"));
		return FinancialYearD;
	}


	public static WebElement ObservationWord() {
		
		ObservationWord=getDriver().findElement(By.xpath("//*[@id='rblRole1']/li[2]/div/ul/li[3]/a"));
		return ObservationWord;
	}

	
	public static WebElement ExportObservationWord() {
		
		ExportObservationWord=getDriver().findElement(By.xpath("//input[@id='ContentPlaceHolder1_btnExportDoc']"));
		return ExportObservationWord;
	}
	...
	public static WebElement Submitted() {
		...
		Submitted=getDriver().findElement(By.xpath("//a[@id='ContentPlaceHolder1_grdAuditStatus_lblRiskCompleted_0']"));
		return Submitted;
	}
	...
	public static WebElement BackButtonS() {
		...
		BackButtonS=getDriver().findElement(By.xpath("//a[@id='ContentPlaceHolder1_btnBack']"));
		return BackButtonS;
	}
	...
	public static WebElement ViewRemarkAndDocument() {
		//*[@id="grdProcessAudit_LinkButton3_0"]/img
		ViewRemarkAndDocument=getDriver().findElement(By.xpath("//*[@id='grdProcessAudit_LinkButton3_0']/img"));
		return ViewRemarkAndDocument;
	}

	
	
	public static WebElement DownloadLink() {
		//*[@id="rptComplianceDocumnets_btnComplianceDocumnets_1"]
		DownloadLink=getDriver().findElement(By.xpath("//a[@id='lnkUploadedDocument']"));
		return DownloadLink;
	}
	...
	public static WebElement CloseButtonv() {
		...
		CloseButtonv=getDriver().findElement(By.xpath("//input[@id='btnCancel']"));
		return CloseButtonv;
	}
	...
	public static WebElement SelectProcess4() {
		...
		SelectProcess4=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_ddlProcess_chosen']"));
		return SelectProcess4;
	}


	public static WebElement SelectProcess4DD() {
		
		SelectProcess4DD=getDriver().findElement(By.xpath("//li[.='Contract and Report']"));
		return SelectProcess4DD;
	}

	
	public static WebElement SelectSubProcess4() {
		
		SelectSubProcess4=getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_ddlSubProcess_chosen']"));
		return SelectSubProcess4;
	}
	...
	public static WebElement SelectSubProcess4DD() {
		...
		SelectSubProcess4DD=getDriver().findElement(By.xpath("//li[.='ARS Audit Two']"));
		return SelectSubProcess4DD;
	}
